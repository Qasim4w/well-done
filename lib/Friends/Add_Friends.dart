...
class Add_Friends_view extends StatefulWidget {
  const Add_Friends_view({Key? key}) : super(key: key);

  @override
  State<Add_Friends_view> createState() => _Add_Friends_viewState();
}

class _Add_Friends_viewState extends State<Add_Friends_view> {
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 50,),
                Text('Add Friend name',style: TextStyle(color: Colors.black),),
                SizedBox(height: 5,),
                App_TextField(hintText: 'Friend name',labelText: '',controller: NameController),
                SizedBox(height: 20,),
                ...
                SizedBox(height: 30,),
                Center(
                  child:AppButton(text: 'save',onPressed: (){Get.to(Friends_list_view());}),
                )
              ],
            ),
          ),
